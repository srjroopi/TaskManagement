...
const DialogTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Trigger> & {
    render?: React.ComponentType<React.HTMLAttributes<HTMLElement> & { className?: string }>
  }
>(({ className, children, render: Render, ...props }, ref) => {
  if (Render) {
    return (
      <DialogPrimitive.Trigger ref={ref} asChild {...props}>
        <Render className={className}>{children}</Render>
